...
namespace blog.MYControls
{
    public class ToggleButton:CheckBox 
    {
        ...
        private Color rediuosColor = Color.White ;
        ...
        [Category("RJ Code Advance")]
        public Color RediuosColor { get => rediuosColor; set { rediuosColor = value; Invalidate(); } }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            pevent.Graphics.Clear(rediuosColor);
            if (base.Checked)
            {
                if (solidStyle)
                {
